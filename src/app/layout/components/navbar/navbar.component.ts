...
export class NavbarComponent implements OnInit, OnDestroy {
    ...
    onLogout() {
        // const message = this.translateService.instant('LOG_OUT_QUESTION');
        // Swal.fire(this.notification.BuildQuestion(message, this.translateService.instant('LOG_OUT'))).then(
        //   (result) => {
        //     if (result.value) {
        //       this.store.dispatch(GeneralAction.logout());
        //     }
        //   }
        // );
