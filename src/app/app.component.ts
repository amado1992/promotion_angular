...
import {AppState} from './main/common/redux/general.reducers';
import {SessionService} from './main/common/services/session.service';
import * as authenticationActions from './main/authentication/redux/authentication.actions';
...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(DOCUMENT) private document: any,
        ...
        this.menu = this._menuPermission.getMenu();
        ...
        this._coreTranslationService.translate(menuSpanish, menuEnglish);
    ...
    ngOnInit(): void {
        ...
        this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
            ...
            // Skin Class (Adding to body as it requires the highest priority)
