...
@Component({
    selector: 'app-customers-new-in-modal',
    templateUrl: './customers-new-in-modal.component.html',
    styleUrls: ['./customers-new-in-modal.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class CustomersNewInModalComponent implements OnInit, AfterViewInit, OnDestroy {
